...
#define W_SURF_BEVELSMASK           ( W_SURF_NODAMAGE | W_SURF_SLICK | W_SURF_CERAMIC | W_SURF_METAL | W_SURF_NOSTEPS | W_SURF_WOOD | W_SURF_GRASS | W_SURF_GRAVEL | W_SURF_GLASS | W_SURF_SNOW | W_SURF_ROOF | W_SURF_RUBBLE | W_SURF_CARPET | W_SURF_MONSTERSLICK | W_SURF_MONSLICK_W | W_SURF_MONSLICK_N | W_SURF_MONSLICK_E | W_SURF_MONSLICK_S )
